...
💛 :yellow_heart:	🖤 :black_heart:	💝 :gift_heart:
...
🍇 :grapes:	🥐 :croissant:	🍓 :strawberry:
🍈 :melon:	🍒 :cherries:	🍑 :peach:
🍞 :bread:	🍍 :pineapple:	🧀 :cheese:
🥚 :egg:	🍅 :tomato:	🍆 :eggplant:
🥑 :avocado:	🥞 :pancakes:	🥓 :bacon:
🥒 :cucumber:	🌶️ :hot_pepper:	🌽 :corn:
🥕 :carrot:	🌭 :hotdog:	🍔 :hamburger:
🥔 :potato:	🍠 :sweet_potato:	🍟 :fries:
🍕 :pizza:	🌮 :taco:	🌯 :burrito:
🍝 :spaghetti:	🍜 :ramen:	🍲 :stew:
🍛 :curry:	🍣 :sushi:	🍱 :bento:
🍙 :rice_ball:	🍚 :rice:	🍢 :oden:
🍡 :dango:	🍨 :ice_cream:	🍦 :icecream:
🍰 :cake:	🍭 :lollipop:	🍬 :candy:
🍿 :popcorn:	🍪 :cookie:	🍩 :doughnut:
🍯 :honey_pot:	🍵 :tea:	☕ :coffee:
🍶 :sake:	🍺 :beer:	🍻 :beers:
...
🔱 :trident:	▪️ :black_small_square:	◾ :black_medium_small_square:
◼️  :black_medium_square:	⬛  :black_large_square:	▫️ :white_small_square:
◽ :white_medium_small_square:	◻️ :white_medium_square:	⬜  :white_large_square:
